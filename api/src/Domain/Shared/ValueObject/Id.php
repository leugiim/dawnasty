...
use App\Domain\Shared\Exception\InvalidUuidFormatException;

/**
 * VO base para todos los *Id del dominio.
 *
 * Valida que el valor recibido es un UUID v4 bien formado. NUNCA genera un
 * id nuevo por sí mismo -- no tiene método generate()/random(). Los ids
 * siempre llegan ya asignados desde el cliente (ver docs/architecture.md,
 * sección 6).
 */
abstract class Id
{
